...
if($_SESSION['logado'] == true){
    ...
    echo '<script>alert("Usuário já tem login");
    window.location="registrarusuariopagina.php";
    </script>';
}
...
if ($nome <> NULL) {
	if (($dadocpf == NULL) && ($dadologin == NULL)){
		$insertusuario = "INSERT INTO usuario (nome, cpf, saldo)
		VALUES 
		('$nome', '$cpf', 0)";
		...
		$insertlogin = "INSERT INTO login (cpf, login, senha, saldo) 
		VALUES
		('$cpf', '$login', '$senhacriptografada', 0)";
